...
export const getMarkdownComponents = () => {
  ...
  return {
    ...
    VideoPlayer,
    View,
    Action1: withStyledTypography(
      action({
        variant: 'action1',
        context: 'markdown'
      })
    ),
    Action2: withStyledTypography(
      action({
        variant: 'action2',
        context: 'markdown'
      })
    ),
    Action3: withStyledTypography(
      action({
        variant: 'action3',
        context: 'markdown'
      })
    ),
    Action4: withStyledTypography(
      action({
        variant: 'action4',
        context: 'markdown'
      })
    ),
    Action5: withStyledTypography(
      action({
        variant: 'action5',
        context: 'markdown'
      })
    ),
    Action6: withStyledTypography(
      action({
        variant: 'action6',
        context: 'markdown'
      })
    ),
    Action7: withStyledTypography(
      action({
        variant: 'action7',
        context: 'markdown'
      })
    ),
    Action8: withStyledTypography(
      action({
        variant: 'action8',
        context: 'markdown'
      })
    ),
    Caption1: withStyledTypography(
      caption({
        variant: 'caption1',
        context: 'markdown'
      })
    ),
    Caption2: withStyledTypography(
      caption({
        variant: 'caption2',
        context: 'markdown'
      })
    ),
    Caption3: withStyledTypography(
      caption({
        variant: 'caption3',
        context: 'markdown'
      })
    ),
    Caption4: withStyledTypography(
      caption({
        variant: 'caption4',
        context: 'markdown'
      })
    ),
    Caption5: withStyledTypography(
      caption({
        variant: 'caption5',
        context: 'markdown'
      })
    ),
    Caption6: withStyledTypography(
      caption({
        variant: 'caption6',
        context: 'markdown'
      })
    ...
    P2: withStyledTypography(
      paragraph({
        variant: 'paragraph2',
        context: 'markdown'
      })
    ),
    P3: withStyledTypography(
      paragraph({
        variant: 'paragraph3',
        context: 'markdown'
      })
    ),
    P4: withStyledTypography(
      paragraph({
        variant: 'paragraph4',
        context: 'markdown'
      })
    ),
    P5: withStyledTypography(
      paragraph({
        variant: 'paragraph5',
        context: 'markdown'
      })
    ),
    P6: withStyledTypography(
      paragraph({
        variant: 'paragraph6',
        context: 'markdown'
      })
    ),
    Subtitle1: withStyledTypography(
      subtitle({
        variant: 'subtitle1',
        context: 'markdown'
      })
    ),
    Subtitle2: withStyledTypography(
      subtitle({
        variant: 'subtitle2',
        context: 'markdown'
      })
    ),
    Subtitle3: withStyledTypography(
      subtitle({
        variant: 'subtitle3',
        context: 'markdown'
      })
    ),
    Subtitle4: withStyledTypography(
      subtitle({
        variant: 'subtitle4',
        context: 'markdown'
      })
    ),
    Subtitle5: withStyledTypography(
      subtitle({
        variant: 'subtitle5',
        context: 'markdown'
      })
    ),
    Subtitle6: withStyledTypography(
      subtitle({
        variant: 'subtitle6',
        context: 'markdown'
      })
