...
export const getMarkdownComponents = () => ({
  ...
  FilterDropdown: withMarkdownSpacing<FilterDropdownProps<any>>(FilterDropdown),
  ...
  FilterSortDropdown: withMarkdownSpacing<FilterSortDropdownProps<any>>(FilterSortDropdown),
  FilterSearch: withMarkdownSpacing<FilterSearchProps<any>>(FilterSearch),
