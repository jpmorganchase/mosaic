...
breadcrumbs:
  ...
  - label: Readme Files
    path: /mosaic/configure/sources/storybook-readme
    id: /mosaic/configure/sources/storybook-readme.mdx
readingTime:
  text: 2 min read
  minutes: 1.285
  time: 77100
...
navigation:
  prev:
    title: Figma Source
    route: /mosaic/configure/sources/storybook-figma
  next:
