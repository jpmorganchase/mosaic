...
breadcrumbs:
  ...
  - label: shouldUpdateNamespaceSources
    path: /mosaic/configure/plugins/lifecycle/should-update-namespace-sources
    id: /mosaic/configure/plugins/lifecycle/should-update-namespace-sources.mdx
readingTime:
  text: 2 min read
  minutes: 1.02
  time: 61200
...
navigation:
  prev:
    ...
    route: /mosaic/configure/plugins/lifecycle/should-clear-cache
  next:
    title: $AliasPlugin
