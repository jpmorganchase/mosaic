...
lastModified: 1781012102897.9746
...
Either snapshot mode can additionally be built as a fully-static site
(`out/` directory of HTML) servable from any CDN with no Node runtime.

Read the [static export](./static-export) docs.
