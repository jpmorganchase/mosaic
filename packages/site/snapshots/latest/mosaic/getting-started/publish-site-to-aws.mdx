...
lastModified: 1780396148468.7544
...
tableOfContents:
  - depth: 2
    level: 0
    id: step-1-create-a-github-repository
    text: 'Step 1: Create a Github repository'
  - depth: 2
    level: 0
    id: step-2-generate-a-snapshot-of-content
    text: 'Step 2: Generate a snapshot of content'
  - depth: 2
    level: 0
    id: step-3-configure-environment-for-s3
    text: 'Step 3: Configure environment for S3'
  - depth: 2
    level: 0
    id: step-4-setup-aws
    text: 'Step 4: Setup AWS'
  - depth: 2
    level: 0
    id: step-5-configure-your-aws-app
    text: 'Step 5: Configure your AWS app'
  - depth: 2
    level: 0
    id: step-6-upload-your-snapshot
    text: 'Step 6: Upload your snapshot'
navigation:
  prev:
    title: Create a Site
...
## Step 2: Generate a snapshot of content
...
## Step 3: Configure environment for S3
