...
sharedConfig:
  ...
  footer:
    ...
    title: Mosaic BETA
    href: /mosaic
lastModified: 1780396147515.087
...
tableOfContents: []
---
<Hero description="Build powerful documentation sites using our NEW scalable solution, watch this space for more developments" eyebrow="Mosaic is currently in BETA" image="/img/hero.png" title="Mosaic" variant="fullWidth" />
