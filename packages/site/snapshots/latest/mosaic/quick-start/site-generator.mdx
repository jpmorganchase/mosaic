...
lastModified: 1683803039977
fullPath: /mosaic/quick-start/site-generator.mdx
route: /mosaic/quick-start/site-generator
breadcrumbs:
  - label: Mosaic
  ...
  - label: Generate a site
    path: /mosaic/quick-start/site-generator.mdx
    id: /mosaic/quick-start/site-generator.mdx
readingTime:
  text: 2 min read
  minutes: 1.3
  time: 78000
...
sidebarData:
  ...
  - id: /mosaic/quick-start/publish-site-to-aws
    ...
    childNodes: []
  - id: /mosaic/quick-start/site-generator
    fullPath: /mosaic/quick-start/site-generator.mdx
    name: Generate a site
    data:
      level: 2
      link: /mosaic/quick-start/site-generator
    childNodes: []
---

# {meta.title}

Use the Mosaic Site generator to generate a site and add an example source.
