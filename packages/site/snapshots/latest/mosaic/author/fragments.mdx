...
```
<Tiles>:fragment{src="../fragments/tile-a.mdx"} :fragment{src="../fragments/tile-b.mdx"}</Tiles>
```

The above code will render the content from tile-a.mdx and tile-b.mdx files within the `<Tiles>` component, demonstrated below:

<Tiles>
<TileContent title="Tile A" description="Tile A description" eyebrow="Eyebrow" />
&#x20;
<TileContent title="Tile B" description="Tile B description" eyebrow="Eyebrow" /> </Tiles>
