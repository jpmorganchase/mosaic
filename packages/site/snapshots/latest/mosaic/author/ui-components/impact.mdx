...
breadcrumbs:
  ...
  - label: Impact
    path: /mosaic/author/ui-components/impact.mdx
    id: /mosaic/author/ui-components/impact.mdx
readingTime:
  text: 1 min read
  minutes: 0.43
  time: 25800
...
tableOfContents:
  ...
  - level: 2
    ...
    text: Code sample
  - level: 3
    id: single-impact-component
    text: Single impact component
  - level: 3
    id: multiple-impact-components
    text: Multiple impact components
navigation:
  prev:
    title: Hero
...
<Impacts>
  <Impact
    image={
      '/img/author/placeholder-icon-impact-40x40.png'
    }
    title="Number"
    label="Metric name"
  />
