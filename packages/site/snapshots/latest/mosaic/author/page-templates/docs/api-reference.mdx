...
sidebar:
  priority: 3
lastModified: 1681740157607
fullPath: /mosaic/author/page-templates/docs/api-reference.mdx
route: /mosaic/author/page-templates/docs/api-reference
readingTime:
  text: 1 min read
  minutes: 0.62
  time: 37200
...
navigation:
  prev:
    title: Glossary
    route: /mosaic/author/page-templates/docs/concepts-and-terminology/glossary
  next:
    title: References
    route: /mosaic/author/page-templates/docs/references/index
sidebarData:
...
Though reference topics in APIs generally receive the most attention, the conceptual topics, such as get-started tutorials, information about authorization, rate limiting, status and error codes, quick reference guides, and other topics constitute about half of the API documentation.
</Callout>
