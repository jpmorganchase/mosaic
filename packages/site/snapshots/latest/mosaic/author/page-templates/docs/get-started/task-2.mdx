...
sidebar:
  priority: 2
lastModified: 1681741911586
fullPath: /mosaic/author/page-templates/docs/get-started/task-2.mdx
route: /mosaic/author/page-templates/docs/get-started/task-2
readingTime:
  text: 2 min read
  minutes: 1.235
  time: 74100
...
navigation:
  prev:
    title: 1. Task 1
    route: /mosaic/author/page-templates/docs/get-started/task-1
  next:
    title: Tutorials
    route: /mosaic/author/page-templates/docs/tutorials/index
sidebarData:
...
![Results image placeholder](.././img/author/placeholder-details-hero-360x271.png)
