...
<Features>
  <Feature image={"./img/author/placeholder-product-hero-feature-552x414.png"}>
    ...
    <FeatureContent>
      <P1 component="span"><b>Challenge</b>: </P1>The description of the challenge.
    </FeatureContent>
    <FeatureContent>
      <P1 component="span"><b>Solution</b>: </P1>The description of the solution and business results.
    </FeatureContent>
  </Feature>
  <Feature image={"./img/author/placeholder-product-hero-feature-552x414.png"}>
