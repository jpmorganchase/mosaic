...
The `MOSAIC_DOCS_CLONE_CREDENTIALS{:bat}` environment variable is composed of your git username and your PAT token.
...
In your browser load `http://localhost:3000{:bat}`
