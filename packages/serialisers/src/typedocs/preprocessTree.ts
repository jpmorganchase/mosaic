...
//This is assigning all html nodes with the className typedoc
//Could this maybe be the first transfomration and then use as a plugin ?
//Assign typedoc to the head ?
