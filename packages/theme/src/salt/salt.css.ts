...
export const colorVars = createGlobalThemeContract({
  ...
  grey10: '--salt-color-grey-10',
  grey20: '--salt-color-grey-20',
  grey30: '--salt-color-grey-30',
  grey40: '--salt-color-grey-40',
  grey50: '--salt-color-grey-50',
  grey60: '--salt-color-grey-60',
  grey70: '--salt-color-grey-70',
  grey80: '--salt-color-grey-80',
  grey90: '--salt-color-grey-90',
  grey100: '--salt-color-grey-100',
  grey200: '--salt-color-grey-200',
  grey300: '--salt-color-grey-300',
  grey400: '--salt-color-grey-400',
  grey500: '--salt-color-grey-500',
  grey600: '--salt-color-grey-600',
  grey700: '--salt-color-grey-700',
  grey800: '--salt-color-grey-800',
  grey900: '--salt-color-grey-900'
});
