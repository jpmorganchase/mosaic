...
To apply your custom styles to your Mosaic site, open your `src/app/layout.tsx`
file and add the following line to the bottom of your imports:

```javascript
import '../css/index.css';
```

> **Note:** in the App Router, global CSS must be imported from the root
> layout (`app/layout.tsx`). Importing global CSS from a client component
> or any non-layout file is rejected by Next.js at build time.
